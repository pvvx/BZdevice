...
typedef bool (*ble_pmEnterCondition_t)(void);
...
typedef struct {
	...
	ble_pmEnterCondition_t	pmEnterCb;
...
void 		bls_pm_setConditionCb (ble_pmEnterCondition_t cb);
 ...
 */
extern void bls_pm_conditionCbRegister(ble_lowpowerCond_t cb);
 ...
 * @return		none
 */
extern void bls_pm_conditionCbUnregister(void);
 ...
 * @return
 */
extern bool bls_pm_conditionCbIsValid(void);
